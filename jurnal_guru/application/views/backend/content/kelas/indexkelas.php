                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('backoffice/kelas/edit/' . $p['kode_kelas']) ?>"><i class='fas fa-edit'></i></a>&nbsp;

                                            <a href="#" onclick="confirm_modal('<?= base_url('backoffice/kelas/delete/' . $p['kode_kelas']); ?>')"><i class='fas fa-trash'></i></a>
