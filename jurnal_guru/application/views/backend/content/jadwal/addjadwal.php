                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" required name="kelas" id="defaultSelect">
                                        ...
                                        foreach ($datakelas as $p) { ?>
                                            <option value="<?= $p['kode_kelas'] ?>"><?= $p['no_kelas'] . ' ' . $p['nama_singkat'] . ' ' . $p['rombel']  ?></option>
                                        <?php  }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" required name="tahun_ajaran" id="defaultSelect">
                                        ...
                                        foreach ($datatahun as $p) { ?>
                                            <option value="<?= $p['kode_tahun'] ?>"><?= $p['tahun']  ?></option>
                                        <?php  }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="time" name="jam_akhir" class="form-control" required placeholder="Contoh : 14:00">
                                    </div>
                                </div>
                            </div>
                        </div>
