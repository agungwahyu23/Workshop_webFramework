                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <h5>Nama Tahun Ajaran <span class="text-danger">*</span></h5>
                                    <div class="controls">
                                        <input type="text" name="tahun" value="<?= Input_helper::postOrOr('tahun', $data['tahun']) ?>" class="form-control" required placeholder="Contoh : 2020/2021">
                                    </div>
                                </div>
                            </div>
                        </div>
