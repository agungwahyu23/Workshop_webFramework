...
public class SumblimePickerFragment extends DialogFragment {
    ...
    public void setCallback(SumblimePickerFragment.Callback callback) {
        mCallback = callback;
    }
