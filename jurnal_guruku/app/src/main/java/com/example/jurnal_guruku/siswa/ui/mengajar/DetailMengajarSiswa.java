...
public class DetailMengajarSiswa extends AppCompatActivity {
    String kode="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_mengajar_siswa);
        ...
        Log.e("kode", kode);
        progressDialog = new ProgressDialog(DetailMengajarSiswa.this);
        loaddata();
...
//                        Toast.makeText(DetailJadwalSiswa.this, respon.getString("pesan"), Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(DetailMengajarSiswa.this, respon.getString("pesan"), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(DetailMengajarSiswa.this, "Terjadi Kesalahan " + error, Toast.LENGTH_SHORT).show();
